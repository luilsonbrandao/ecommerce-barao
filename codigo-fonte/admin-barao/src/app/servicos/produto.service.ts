...
export class ProdutoService {
  ...
  public buscarCompradoresDoProduto(
    idProduto: number,
  ): Observable<CompradorDTO[]> {
    return this.http.get<CompradorDTO[]>(
      `https://interlocutorily-thermonuclear-toshia.ngrok-free.dev/pedido/produto/${idProduto}/compradores`,
      this.getAuthHeaders(),
    );
  }
}
