...
export class RegistrofinanceiroService {
  ...
  public gerarRegistroFinanceiro(registro: RegistroFinanceiro): Observable<string> {
  ...
  public recuperarRegistrosFinanceiros(): Observable<ItemFinanceiroDTO[]> {
    return this.http.get<ItemFinanceiroDTO[]>(this.apiUrl, this.tokenSrv.getHeader());
  }

  public alterarStatusItem(item: ItemFinanceiroDTO): Observable<ItemFinanceiroDTO> {
    return this.http.put<ItemFinanceiroDTO>(this.apiUrl, item, this.tokenSrv.getHeader());
  }
}
